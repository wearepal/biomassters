...
class SentinelDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        self.transform_s2 = T.Sentinel2Scale()
        self.transform_s1 = T.Sentinel1Scale()
    ...
    def __getitem__(self, index: int) -> Sample:
        ...
        # Sentinel 1
        try:
            s1_tile = self._load_sentinel_tiles("S1", chipid=chipid, month=month)
        ...
        # Sentinel 2
        try:
            s2_tile = self._load_sentinel_tiles("S2", chipid=chipid, month=month)
    ...
    def _load_sentinel_tiles(self, sentinel_type: str, *, chipid: int, month: str) -> Tensor:
    ...
    def _load_agbm_tile(self, chipid: int) -> Tensor:
